function CPlayerGUI(iX,iY,szName,oParentContainer){
    ...
    this.updatePlayerName = function(szNewName){
        _szName = szNewName;
        _oTextName.refreshText(szNewName);
    };
    
    this.setName = function(szNewName){
        _szName = szNewName;
        _oTextName.refreshText(szNewName);
        console.log("CPlayerGUI: Имя игрока обновлено на", szNewName);
    };
