function CRoomList() {
  ...
  this.addRoom = function (data) {
    console.log('[CRoomList] addRoom', data);
  ...
  this.setRoom = function (datas) {
    console.log('[CRoomList] setRoom', datas);
    // $(".content-wraper").html("");
    datas.forEach((room) => {
  ...
  this.onJoinRes = function (res) {
    console.log('[CRoomList] onJoinRes', res);
    if (res.success) {
  ...
  this.quckJoin = function () {
    console.log('[CRoomList] quckJoin');
    socket.emit("joinroom-req");
  };

  this.refreshRooms = function () {
    console.log('[CRoomList] refreshRooms');
    $(".content-wraper").html("");
    socket.emit("getall-room");
  };

  this.onOpenRoom = function (pid) {
    console.log('[CRoomList] onOpenRoom', pid);
  ...
  this.spectator = function (roomid) {
    console.log('[CRoomList] spectator', roomid);
    socket.emit("spectator-req", roomid);
  };

  this.joinRoom = function (roomid) {
    console.log('[CRoomList] joinRoom', roomid);
    socket.emit("joinroom-req", roomid);
  };

  this.searchRoom = function () {
    console.log('[CRoomList] searchRoom');
